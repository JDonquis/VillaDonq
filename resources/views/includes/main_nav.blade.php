        ...
        <div class="container">  
            ...
            <a href="{{route("welcome")}}" class="transition_link">
                <picture class="logo transition_link">
                    <source media="(min-width: 700px)" srcset="{{asset("assets/img/VD.png")}}" class="transition_link">
                    <img src="{{asset("assets/img/Logo.png")}}" alt="" class="big-logo transition_link">
                </picture>
            </a>
        ...
        <div class="container">  
            ...
            <a href="{{route("welcome")}}" class="transition_link">
                <picture class="logo transition_link">
                    ...
                    <img src="{{asset("assets/img/Logo.png")}}" alt="" class="small-logo transition_link">
                </picture>
            </a>
            <div class="nav-section">
                @if(!session()->has('id_user'))
