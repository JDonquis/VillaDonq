<form class="login_form modal_form" action="{{route('login_request')}}" method="POST">
    @csrf
    <a class="close_btn_modal trigger_modal" data-modal="login_form" type="menu">
