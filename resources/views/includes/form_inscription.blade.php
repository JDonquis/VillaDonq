<form class="inscribe modal_form" show="{{old("DNI")?'active':'active'}}" id="form-file" action="{{route('inscription_request')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="slider_wrap">
                ...
                <div class="row w-full mb-3">
                    <div class="col-4">
                        <select name="year" id="ins-year">
                            <option class="h6" value="">1 año</option>
                        </select>
                    </div>
                    <div class="col-4">
                        <select name="section" id="ins-year">
                            <option class="h6" value="">Sección A</option>
                        </select>
                    </div>
                    <div class="col-4">
                        <select name="section" id="ins-year">
                            <option class="h6" value="">Masculino</option>
                            <option class="h6" value="">Femenino</option>
                        </select>
                    </div>
                </div>
            ...
            @for($j = $start; $j<$start+3;$j++) @php if(!isset($docs[$j])) break; @endphp <label for="ins_{{$docs[$j]->name}}">{{ str_replace('_', ' ',$docs[$j]->name)}}: </label>
                ...
                <fieldset class="each_slider_element">
                    ...
                    <textarea class="mb-4" name="work_location" id="work_location" cols="30" rows="2" style="max-height: 100px;">{{old("work_location")}}</textarea>
                ...
                <fieldset class="each_slider_element">
                    ...
                    <label for="work_location">Lugar de trabajo</label>
                    <textarea class="mb-2" name="address" id="work_location" cols="30" rows="2" style="max-height: 100px;">{{old("work_location")}}</textarea>
