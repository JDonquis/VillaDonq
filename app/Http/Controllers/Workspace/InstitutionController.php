...
use App\Http\Requests\InstitutionInfoRequest;
...
class InstitutionController extends Controller
{
    ...
    {   
        $info = InstitutionInfo::orderBy("id","desc")->first();
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InstitutionInfoRequest $request)
    {
        if($request->ajax())
        {
            InstitutionInfo::create($request->all());
